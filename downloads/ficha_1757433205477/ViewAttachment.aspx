    ...
    <section class="container buscador-seccion">
        <div class="col-xs-12 bloque">
            <div id="dvTotalOportunidades" class="row">
                <h1 class="text-center text-light" id="monto-titulo">Encuentra hasta <span class="text-light pri-color">4498</span> oportunidades de negocio en todo Chile</h1>

            </div>
<form action="/Home/BusquedaLicitacion" id="formBusqueda" method="post"><input name="__RequestVerificationToken" type="hidden" value="Wqc82rjYlWtD8Ui5TQXd6J0VhVxbpS_60LunT_TgAcP_6D7KVkOykmZpIQ2QxAzLgsFdA4dVBTxpYB2VWcAEwhaMr4Q3OyVDhyxBcHHw4v49RdSfiPq0rpSDfdU1" />                <div class="row">
