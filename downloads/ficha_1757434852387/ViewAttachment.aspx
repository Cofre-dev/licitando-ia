    ...
    <section class="container buscador-seccion">
        <div class="col-xs-12 bloque">
            <div id="dvTotalOportunidades" class="row">
                <h1 class="text-center text-light" id="monto-titulo">Encuentra hasta <span class="text-light pri-color">4516</span> oportunidades de negocio en todo Chile</h1>

            </div>
<form action="/Home/BusquedaLicitacion" id="formBusqueda" method="post"><input name="__RequestVerificationToken" type="hidden" value="RU-uVbsj4F3KdUGHNe4qj0Zy_LMBPOYxVMVW9Fa2Prht6D66bXl_tR4Fq5Dm5NHUpvP4O9oezxzXJTAnoxWBBCcPQPJ98acI5Z5pySDK4U3ENED6bLD5Dbdv_Ng1" />                <div class="row">
