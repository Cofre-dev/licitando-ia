    ...
    <section class="container buscador-seccion">
        <div class="col-xs-12 bloque">
            <div id="dvTotalOportunidades" class="row">
                <h1 class="text-center text-light" id="monto-titulo">Encuentra hasta <span class="text-light pri-color">4517</span> oportunidades de negocio en todo Chile</h1>

            </div>
<form action="/Home/BusquedaLicitacion" id="formBusqueda" method="post"><input name="__RequestVerificationToken" type="hidden" value="FI8Nj7a8FnfLgj8DAVPamr_kDQbyDnIwCcKur2cR0lXZC7iAz24ylwthXosIB9D3Ckq1-sd18z6vKX3YzDdqVbq--GHN_H8sXvWmwy2Y8dUBnU7C6C864JU-EtE1" />                <div class="row">
